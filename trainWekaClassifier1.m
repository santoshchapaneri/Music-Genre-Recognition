...
%     kernel = javaObject('weka.classifiers.trees.J48');
%     c = weka.classifiers.functions.SMO();     
   wekaClassifier.setC(1.0);
  k = weka.classifiers.functions.supportVector.polynomial();
%   k.setOmega(1.0);
%   k.setSigma(1.0);
   wekaClassifier.setKernel(k);  
%     wekaClassifier.setKernel(kernel);
